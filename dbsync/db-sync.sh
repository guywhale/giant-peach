...
mysqldump --column-statistics=0 -v -h $LOCAL_DATABASE_HOST --port=$LOCAL_PORT -u $LOCAL_DATABASE_USER -p$LOCAL_DATABASE_PASS $LOCAL_DATABASE_NAME > "$CONFIG"/dbsync/dumps/local-database-$CURRENT_TIME.sql
